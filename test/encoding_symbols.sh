...
# strtoll/strtoull parse typed XML integer fields. Current glibc headers may
# redirect them to __isoc23_strtoll/__isoc23_strtoull. Darwin's errno macro
# calls __error; glibc and musl use __errno_location. These are libc entries.
#
