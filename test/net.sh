...
grep -A20 'Value net_accept' compiler/bootstrap/builtins.cpp | grep -q 'deadline - net_millis'
...
grep -q 'MSG_NOSIGNAL' compiler/bootstrap/builtins.cpp
grep -q 'SO_NOSIGPIPE' compiler/bootstrap/builtins.cpp
