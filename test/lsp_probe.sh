...
# stdlib symbol: signature comes from the real Beans source in stdlib/std
gcd=$(grep -n 'fn gcd' stdlib/std/math/math.b | head -1 | cut -d: -f1)
expect "stdlib/std/math/math.b:$gcd:8" 'pub fn gcd(a: int, b: int) -> int'
