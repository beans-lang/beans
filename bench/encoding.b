...
//   base64 encode:  1 request + 1 final string (native)
//   base64 decode:  1 request + 1 Bytes; decoded output shrinks in place and
//                   native input is borrowed directly
//   json parse:     1 request + 1 document + 1 owner + 1 Value
//   json stringify: 1 request + 1 native buffer + 1 final string
//   xml parse:      1 request + 1 document + 1 owner
//   xml stringify:  1 request + 1 native buffer + 1 final string
...
fn main() {
    let mode: string = os.args().get(0).or("all")
