...
partial class LlvmTextEmitter {
    ...
    fn emit_json_decode_direct(
        ...
        // The decoder's diagnostic probe travels out through the request
        ...
        self.require_declare(
            "beans_json_decode_probe_publish",
            "void @beans_json_decode_probe_publish(i64, i64, i64, i64)")
