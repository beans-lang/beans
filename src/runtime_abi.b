...
// it. test/self_host.sh is what catches the drift.
...
pub fn runtime_builtin_method(key: string) -> Option<RuntimeBuiltin> {
    ...
    if key == "File.read_text_at" {
        return some(new RuntimeBuiltin(
            ["i64", "i64"],
            "res_str", "beans_file_read_text_at", false))
    }
    ...
    if key == "File.write_text_at" {
        return some(new RuntimeBuiltin(
            ["i64", "str"],
            "res_i64", "beans_file_write_text_at", false))
    }
    if key == "File.read" {
        return some(new RuntimeBuiltin(
            ["i64"],
    ...
    if key == "File.read_text" {
        return some(new RuntimeBuiltin(
            ["i64"],
            "res_str", "beans_file_read_text", false))
    }
    if key == "File.write" {
        return some(new RuntimeBuiltin(
            ["bytes"],
    ...
    if key == "File.write_text" {
        return some(new RuntimeBuiltin(
            ["str"],
            "res_i64", "beans_file_write_text", false))
    }
    if key == "File.seek" {
        return some(new RuntimeBuiltin(
            ["i64"],
...
pub fn runtime_builtin_fn(key: string) -> Option<RuntimeBuiltin> {
    if key == "std.reflection.annotation_type_count" {
        return some(new RuntimeBuiltin(
            [], "i64", "beans_reflect_annotation_type_count", false))
    }
    if key == "std.reflection.annotation_type_at" {
        return some(new RuntimeBuiltin(
            ["i64"], "str", "beans_reflect_annotation_type_at", false))
    }
    if key == "std.reflection.annotation_type_flags" ||
       key == "std.reflection.annotation_type_target_count" ||
       key == "std.reflection.annotation_type_field_count" {
        return some(new RuntimeBuiltin(
            ["str"], "i64",
            "beans_reflect_{key.slice(15, key.len())}", false))
    }
    if key == "std.reflection.annotation_type_retention" {
        return some(new RuntimeBuiltin(
            ["str"], "str", "beans_reflect_annotation_type_retention", false))
    }
    if key == "std.reflection.annotation_type_target_at" ||
       key == "std.reflection.annotation_type_field_name" ||
       key == "std.reflection.annotation_type_field_type" {
        return some(new RuntimeBuiltin(
            ["str", "i64"], "str",
            "beans_reflect_{key.slice(15, key.len())}", false))
    }
    if key == "std.reflection.annotation_type_field_flags" ||
       key == "std.reflection.annotation_type_field_default" {
        return some(new RuntimeBuiltin(
            ["str", "i64"], "i64",
            "beans_reflect_{key.slice(15, key.len())}", false))
    }
    if key == "std.reflection.annotation_count" {
        return some(new RuntimeBuiltin(
            ["i64", "str", "str", "i64"], "i64",
            "beans_reflect_annotation_count", false))
    }
    if key == "std.reflection.annotation_at" {
        return some(new RuntimeBuiltin(
            ["i64", "str", "str", "i64", "i64"], "i64",
            "beans_reflect_annotation_at", false))
    }
    if key == "std.reflection.annotation_name" ||
       key == "std.reflection.annotation_argument_name" ||
       key == "std.reflection.annotation_value_type" ||
       key == "std.reflection.annotation_value_text" {
        return some(new RuntimeBuiltin(
            ["i64"], "str",
            "beans_reflect_{key.slice(15, key.len())}", false))
    }
    if key == "std.reflection.annotation_argument_count" ||
       key == "std.reflection.annotation_value_kind" ||
       key == "std.reflection.annotation_value_item_count" {
        return some(new RuntimeBuiltin(
            ["i64"], "i64",
            "beans_reflect_{key.slice(15, key.len())}", false))
    }
    if key == "std.reflection.annotation_argument_at" ||
       key == "std.reflection.annotation_value_item_at" {
        return some(new RuntimeBuiltin(
            ["i64", "i64"], "i64",
            "beans_reflect_{key.slice(15, key.len())}", false))
    }
    if key == "std.reflection.annotation_value_bool" {
        return some(new RuntimeBuiltin(
            ["i64"], "bool",
            "beans_reflect_annotation_value_bool", false))
    }
    if key == "std.reflection.error_code" {
        return some(new RuntimeBuiltin(
            [], "i64", "beans_reflect_error_code", false))
    }
    if key == "std.reflection.error_message" {
        return some(new RuntimeBuiltin(
            [], "str", "beans_reflect_error_message", false))
    }
    if key == "std.reflection.field_get" {
        return some(new RuntimeBuiltin(
            ["str", "str", "i64"], "i64",
            "beans_reflect_field_get", false))
    }
    if key == "std.reflection.field_set" {
        return some(new RuntimeBuiltin(
            ["str", "str", "i64", "i64"], "bool",
            "beans_reflect_field_set", false))
    }
    if key == "std.reflection.function_call" {
        return some(new RuntimeBuiltin(
            ["str", "i64", "i64"], "i64",
            "beans_reflect_function_call", false))
    }
    if key == "std.reflection.method_call" {
        return some(new RuntimeBuiltin(
    ...
    if key == "std.reflection.initializer_parameter_name" ||
       key == "std.reflection.initializer_parameter_type" {
        return some(new RuntimeBuiltin(
            ["str", "i64"], "str",
            "beans_reflect_{key.slice(15, key.len())}", false))
    }
    if key == "std.reflection.initializer_parameter_passing" {
        return some(new RuntimeBuiltin(
            ["str", "i64"], "i64",
            "beans_reflect_initializer_parameter_passing", false))
    }
    if key == "std.reflection.initializer_call" {
        return some(new RuntimeBuiltin(
            ["str", "i64", "i64"], "i64",
            "beans_reflect_initializer_call", false))
    }
    if key == "std.reflection.variant_make" {
        return some(new RuntimeBuiltin(
            ["str", "str", "i64", "i64"], "i64",
            "beans_reflect_variant_make", false))
    }
    if key == "std.reflection.value_type" {
        return some(new RuntimeBuiltin(
            ["i64"], "str", "beans_reflect_value_type", false))
    }
    if key == "std.reflection.value_clone" {
        return some(new RuntimeBuiltin(
            ["i64"], "i64", "beans_reflect_value_clone", false))
    }
    if key == "std.reflection.value_drop" {
        return some(new RuntimeBuiltin(
            ["i64"], "unit", "beans_reflect_value_drop", false))
    }
    if key == "std.reflection.value_matches" {
        return some(new RuntimeBuiltin(
            ["i64", "str"], "bool",
            "beans_reflect_value_matches", false))
    }
    if key == "std.reflection.type_kind" ||
       key == "std.reflection.type_argument_count" ||
       key == "std.reflection.interface_count" {
        return some(new RuntimeBuiltin(
            ["str"], "i64",
            "beans_reflect_{key.slice(15, key.len())}", false))
    }
    if key == "std.reflection.type_argument_at" ||
       key == "std.reflection.interface_at" {
        return some(new RuntimeBuiltin(
            ["str", "i64"], "str",
            "beans_reflect_{key.slice(15, key.len())}", false))
    }
    if key == "std.reflection.base_type" {
        return some(new RuntimeBuiltin(
            ["str"], "str", "beans_reflect_base_type", false))
    }
    if key == "std.reflection.is_assignable_from" {
        return some(new RuntimeBuiltin(
            ["str", "str"], "bool",
            "beans_reflect_is_assignable_from", false))
    }
    if key == "std.reflection.field_count" {
        return some(new RuntimeBuiltin(
            ["str", "bool"], "i64",
            "beans_reflect_field_count", false))
    }
    if key == "std.reflection.field_name" ||
       key == "std.reflection.field_type" ||
       key == "std.reflection.field_owner" {
        return some(new RuntimeBuiltin(
            ["str", "bool", "i64"], "str",
            "beans_reflect_{key.slice(15, key.len())}", false))
    }
    if key == "std.reflection.field_flags" {
        return some(new RuntimeBuiltin(
            ["str", "bool", "i64"], "i64",
            "beans_reflect_field_flags", false))
    }
    if key == "std.reflection.method_count" {
        return some(new RuntimeBuiltin(
            ["str", "bool"], "i64",
            "beans_reflect_method_count", false))
    }
    if key == "std.reflection.method_name" {
        return some(new RuntimeBuiltin(
            ["str", "bool", "i64"], "str",
            "beans_reflect_method_name", false))
    }
    if key == "std.reflection.method_flags" ||
       key == "std.reflection.method_parameter_count" {
        return some(new RuntimeBuiltin(
            ["str", "str"], "i64",
            "beans_reflect_{key.slice(15, key.len())}", false))
    }
    if key == "std.reflection.method_owner" ||
       key == "std.reflection.method_result" {
        return some(new RuntimeBuiltin(
            ["str", "str"], "str",
            "beans_reflect_{key.slice(15, key.len())}", false))
    }
    if key == "std.reflection.method_parameter_name" ||
       key == "std.reflection.method_parameter_type" {
        return some(new RuntimeBuiltin(
            ["str", "str", "i64"], "str",
            "beans_reflect_{key.slice(15, key.len())}", false))
    }
    if key == "std.reflection.method_parameter_passing" {
        return some(new RuntimeBuiltin(
            ["str", "str", "i64"], "i64",
            "beans_reflect_method_parameter_passing", false))
    }
    if key == "std.reflection.variant_count" {
        return some(new RuntimeBuiltin(
            ["str"], "i64", "beans_reflect_variant_count", false))
    }
    if key == "std.reflection.variant_name" {
        return some(new RuntimeBuiltin(
            ["str", "i64"], "str",
            "beans_reflect_variant_name", false))
    }
    if key == "std.reflection.variant_parameter_count" {
        return some(new RuntimeBuiltin(
            ["str", "str"], "i64",
            "beans_reflect_variant_parameter_count", false))
    }
    if key == "std.reflection.variant_parameter_name" ||
       key == "std.reflection.variant_parameter_type" {
        return some(new RuntimeBuiltin(
            ["str", "str", "i64"], "str",
            "beans_reflect_{key.slice(15, key.len())}", false))
    }
    if key == "std.reflection.function_name" ||
       key == "std.reflection.function_result" {
        return some(new RuntimeBuiltin(
            ["str"], "str",
            "beans_reflect_{key.slice(15, key.len())}", false))
    }
    if key == "std.reflection.function_flags" ||
       key == "std.reflection.function_parameter_count" {
        return some(new RuntimeBuiltin(
            ["str"], "i64",
            "beans_reflect_{key.slice(15, key.len())}", false))
    }
    if key == "std.reflection.function_parameter_name" ||
       key == "std.reflection.function_parameter_type" {
        return some(new RuntimeBuiltin(
            ["str", "i64"], "str",
            "beans_reflect_{key.slice(15, key.len())}", false))
    }
    if key == "std.reflection.function_parameter_passing" {
        return some(new RuntimeBuiltin(
            ["str", "i64"], "i64",
            "beans_reflect_function_parameter_passing", false))
    }
    if key == "std.reflection.registry_type_count" ||
       key == "std.reflection.registry_function_count" {
        return some(new RuntimeBuiltin(
            [], "i64",
            "beans_reflect_{key.slice(15, key.len())}", false))
    }
    if key == "std.reflection.registry_type_at" ||
       key == "std.reflection.registry_function_at" {
        return some(new RuntimeBuiltin(
            ["i64"], "str",
            "beans_reflect_{key.slice(15, key.len())}", false))
    }
    ...
    if key == "std.proc.run" {
        return some(new RuntimeBuiltin(
            ...
            "res_list_bytes", "beans_proc_run", false))
    }
    ...
    if key == "std.proc.write_text" {
        return some(new RuntimeBuiltin(
            ["i64", "str", "i64"],
            "res_i64", "beans_proc_write_text", false))
    }
    ...
    if key == "std.proc.read_to_end" {
        return some(new RuntimeBuiltin(
            ["i64", "i64"],
            "res_bytes", "beans_proc_read_to_end", false))
    }
    ...
    if key == "std.sock.recv_exact" ||
       key == "std.sock.recv_to_end" {
        return some(new RuntimeBuiltin(
            ["i64", "i64"],
            "res_bytes",
            if key == "std.sock.recv_exact" {
                "beans_net_recv_exact"
            } else {
                "beans_net_recv_to_end"
            }, false))
    }
    ...
    if key == "std.sock.recv_from" {
        return some(new RuntimeBuiltin(
            ["i64", "i64"],
            "res_list_bytes", "beans_net_recv_from", false))
    }
    if key == "std.sock.address" {
        return some(new RuntimeBuiltin(
            ["i64", "bool"],
            "res_list_bytes", "beans_net_address", false))
    }
